...
class wootour_Settings {
	...
	private function settings_fields() {
		$settings['general'] = array(
			...
			'fields'				=> array(
				...
				array(
					...
					'label'			=> esc_html__( 'Calendar date format', 'woo-tour' ),
					'description'	=> '',
					'type'			=> 'text',
		...
		$settings_ge =  array(
				...
				array(
					'id' 			=> 'wt_date_picker',
					'label'			=> esc_html__( 'Admin date picker format', 'exthemes' ),
					'description'	=> '',
					'type'			=> 'select',
					'options'		=> array( 
						'' => esc_html__( 'mm/dd/yyyy', 'exthemes' ),
						'dmy' => esc_html__( 'dd/mm/yyyy', 'exthemes' ),
						),
					'default'		=> ''
				),
				array(
				...
				array(
					...
					'description'	=> esc_html__( 'Select disable to using one stock for all variations', 'woo-tour' ),
					'type'			=> 'select',
					'options'		=> array( 
		...
		$settings_2 = array(
			...
			array(
				...
				'label'			=> esc_html__( 'Disable default quantity field', 'woo-tour' ),
				'description'	=> '',
				'type'			=> 'select',
				'options'		=> array( 
					'' => esc_html__( 'No', 'woo-tour' ),
		...
		if($wt_main_purpose=='meta'){
			$optionsg = array_merge($settings_2, $settings_ge);
		}else{ $optionsg = array_merge($settings_1, $settings_ge);}
