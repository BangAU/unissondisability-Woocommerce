	        	...
	        	<?php if($search_style!='modern'){?>
		            ...
		            <?php if ( ! empty( $terms ) && ! is_wp_error( $terms ) ){ ?>
		              <div class="exwt-input-group-btn wt-search-dropdown">
		                <button name="wt_location" type="button" class="exwt-btn exwt-btn-default wt-product-search-dropdown-button wt-showdrd"><span class="button-label"><?php echo esc_html__('Locations','woo-tour'); ?></span> <span class="fa fa-angle-down"></span></button>
