...
class SubMenu {
	...
	public function register_sub_menu() {
		add_submenu_page(
			null, 'Upgrade to Premium', 'Upgrade to Premium', 'manage_options', 'codeixer-upgrade', array( &$this, 'submenu_page_callback' )
		);
	...
	public function submenu_page_callback() {
		...
		if ( isset( $_GET['subpage'] ) && $_GET['subpage'] == 'bayna' ) {
		?>
			...
			<div class="fw-row">
				...
				<div class="fw-col-md-4">
					<div class="cit-item-action">
						...
						<a target="_blank" href="https://www.codeixer.com/deposits-payment-plugin-for-woocommerce/#pricing" class="cit-action-btn">Get started</a>
