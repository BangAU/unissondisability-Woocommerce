...
namespace SW_WAPF_PRO\Includes\Classes {
    ...
    class Conditions
    {
        public static function get_field_visibility_conditions() {
            ...
            $options = array(
	            ...
	            array(
		            'type'          => 'date',
		            'conditions'    => array(
			            array('value' => 'empty', 'label' => __('Date is empty','sw-wapf'), 'type' => false),
			            array('value' => '!empty', 'label' => __('Date is any date','sw-wapf'), 'type' => false),
			            array('value' => '==', 'label' => __('Date is equal to','sw-wapf'), 'type' => 'text', 'desc' => __('Use this date format: mm-dd-yyyy','sw-wapf')),
			            array('value' => '!=', 'label' => __('Date is not equal to','sw-wapf'), 'type' => 'text', 'desc' => __('Use this date format: mm-dd-yyyy','sw-wapf')),
			            array('value' => 'gtd', 'label' => __('Date is later than','sw-wapf'), 'type' => 'text', 'desc' => __('Use this date format: mm-dd-yyyy','sw-wapf')),
			            array('value' => 'ltd', 'label' => __('Date is older than','sw-wapf'), 'type' => 'text', 'desc' => __('Use this date format: mm-dd-yyyy','sw-wapf')),
		            )
	            ),
                array(
                    'type'          => 'image-swatch',
        ...
        private static function check($condition, $value, $product = null)
        {
            ...
            return apply_filters('wapf/field_group/is_condition_valid',false,$condition,$value, array('product' => $product));
