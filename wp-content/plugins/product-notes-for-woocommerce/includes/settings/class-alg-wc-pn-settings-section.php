	...
	function get_settings() {
		...
		$advanced_settings = array(
			array(
				...
				'type'     => 'title',
				'id'       => "alg_wc_pn_{$private_or_public}_advanced_options",
			),
			array(
				'title'    => __( 'Delete notes', 'product-notes-for-woocommerce' ),
				'desc'     => '<span style="color:red;"><strong>' . __( 'Delete', 'product-notes-for-woocommerce' ) . '</strong></span>',
				'desc_tip' => __( 'Deletes all notes for all products.', 'product-notes-for-woocommerce' ) . ' ' .
					__( 'Check the box and save changes to delete notes.', 'product-notes-for-woocommerce' ) . ' ' .
					__( 'Please note that there is no undo for this action.', 'product-notes-for-woocommerce' ),
				'id'       => "alg_wc_pn_{$private_or_public}_delete_all",
				'default'  => 'no',
				'type'     => 'checkbox',
			),
			array(
		...
		return array_merge( $general_settings, $frontend_settings, $backend_settings, $advanced_settings );
	}
